...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [12541591.060226, -822272.607089, 12569778.830079, -801958.847360], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([12541591.060226, -822272.607089, 12569778.830079, -801958.847360], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sebaran Halte Bus di Sekitar Surabaya</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_SebaranHalteBusSurabaya_4,
    colName: 'name',
    zoom: 10,
    collapsed: true,
    map: map
